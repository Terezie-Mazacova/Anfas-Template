<%@ Page language="C#" %>
<je:container runat="server" source="contact">
    ...
    <section class="canvas canvas--first canvas--white">
        <div class="row">
            <div class="column medium-12 small-12">
                <je:img runat="server" field=".photo" size="thumb" class="image mb-6" />                
            </div>
        </div>

        <div class="row">
            <je:repeater runat="server" source=".contacts">
                <item>
                    <div class="column medium-4 small-4">
                        <je:img runat="server" field=".photo" size="thumb" class="img mb-6" />
                        <je:item runat="server" field=".name" tag="p" class="paragraph" />
                    </div>
                </item>
            </je:repeater>
        </div>
